...
# establishing a connection to the olympic database
try:
...
def get_medalists(games_id):
    ...
    if noc is not None:
        query = '''SELECT athletes.id, athletes.full_name, athletes.sex, events.sport, 
                        events.event_competed, performances.medal
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('An olympic data Flask application/API')
